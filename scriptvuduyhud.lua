...
local Window = Fluent:CreateWindow({
    Title = "Vũ DUY HUD",
    SubTitle = "BY VŨ DUY MODS/UPDATE'20",
    TabWidth = 160,
...
--Create Tabs
    ...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleAutoFarmLevel", {Title = "Bắt Đầu Farm", Default = false })
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Farm Quái Ở Gần", Default = false })
    ...
    spawn(function()
      ...
      Tabs.Main:AddButton({
        Title = "Tự Động x2 exp",
        Description = "Auto Dán Code x2 Kinh Nghiệm",
        Callback = function()
            UseCode()
        end
    })
...
--Mastery
    Tabs.Main:AddParagraph({
        Title = "Fame Thông thạo",
        Content = "Auto Thông thạo Cheat-Anti"
    })
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Farm Thông thạo Fruit", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Farm Thông thạo Súng", Default = false })
...
Tabs.Main:AddParagraph({
    Title = "Misic Fame",
    Content = "Farm Xương & Farm Katakuri & "
})

local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Fame Xương", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Fame Katakuri", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Farm Vật chất Ki Di", Default = false })
...
CamShake:Stop()
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Auto shift island", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "xoá Hiệu Ứng Dame", Default = true })
...
Tabs.Player:AddButton({
    Title = "Reset Chọn người Chơi Đánh",
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Đánh Người chơi Farm", Default = false })
...
Tabs.Teleport:AddParagraph({
    Title = "Dịch chuyển Sea",
    Content = "Sea1 & Sea2 & Sea3"
})

Tabs.Teleport:AddButton({
    Title = "Dịch chuyển đến Sea1",
    Description = "",
    Callback = function()
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Esp Người Chơi", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Esp Trái Blox", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "Esp Đảo", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Esp Hoa", Default = false })
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title = "Mua Chíp Raid", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Giết Quái Đảo Raid", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Quay Xương", Default = false })
